"""
Django settings for news_all project.
...
SECRET_KEY = 'django-insecure-vi)n+89_6oda=*ns430vm*8uwm@i^j%u2#%(y$^zz#hq5h8f^l'
...
WSGI_APPLICATION = 'news_all.wsgi.application'
